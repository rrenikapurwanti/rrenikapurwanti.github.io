...
filemtime('C:\webserver\lizmap\prod\release_3_3\lizmap/modules/admin/forms/config_services.form.xml') > 1584482039){ return false;
}else{
...
$this->addControl($ctrl);
$ctrl= new jFormsControlmenulist('proxyMethod');
$ctrl->required=true;
$ctrl->label=jLocale::get('admin~admin.form.admin_services.proxyMethod.label');
$ctrl->datasource= new jFormsStaticDatasource();
$ctrl->datasource->data = array('php'=>jLocale::get('admin~admin.form.admin_services.proxyMethod.php.label'),'curl'=>jLocale::get('admin~admin.form.admin_services.proxyMethod.curl.label'),);
$ctrl->defaultValue=array (
  0 => 'php',
);
$this->addControl($ctrl);
