<?php $_loaded= array (
  ...
  'configuration.services.wmsMaxWidth.label' => 'Maximum Witdh for GetMap request',
  ...
  'configuration.services.proxyMethod.label' => 'Send request to QGIS Server with',
  ...
  'form.admin_services.message.wmsPublicUrlList.wrong' => 'The WMS subdomain URLs structure is not valide.',
  'form.admin_services.wmsMaxWidth.label' => 'Default max. Witdh for GetMap request',
  ...
  'form.admin_services.message.cacheRootDirectory.wrong' => 'The directory does not exists or is not writable. You can use: %s',
  ...
  'form.admin_section.message.data.saved' => 'The repository data have been saved.',
  ...
  'form.admin_section.message.path.wrong' => 'The path given for the repository does not exists on the server.',
  ...
  'theme.button.remove.logo.confirm.label' => 'Remove this image (and use default one) ?',
  'cache.repository.removed' => 'The cache for the repository %s has been sucessfully emptied.',
  'cache.layer.removed' => 'The cache for the layer %s has been sucessfully emptied.',
