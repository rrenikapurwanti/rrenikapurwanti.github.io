...
filemtime('C:\webserver\lizmap\prod\release_3_3\lizmap/modules/view/templates/view.tpl') > 1584482039){ return false;
} else {
 require_once('C:\webserver\lizmap\prod\release_3_3\lib\jelix/plugins/tpl/html/meta.html.php');
 require_once('C:\webserver\lizmap\prod\release_3_3\lib\jelix/plugins/tpl/common/modifier.truncate.php');
 require_once('C:\webserver\lizmap\prod\release_3_3\lib\jelix/plugins/tpl/html/modifier.nl2br.php');
  ...
  <li class="span3 liz-repository-project-item">
    <div class="thumbnail">
      ...
      <p style="text-align:center;">
        <a class="btn liz-project-view" href="<?php echo $t->_vars['p']->url; ?>"><?php echo jLocale::get('default.project.open.map'); ?></a>
