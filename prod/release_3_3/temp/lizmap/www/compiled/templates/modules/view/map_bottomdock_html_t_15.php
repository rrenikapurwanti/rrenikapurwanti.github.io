...
filemtime('C:\webserver\lizmap\prod\release_3_3\lizmap/modules/view/templates/map_bottomdock.tpl') > 1582985478){ return false;
} else {
...
?>    <div class="tabbable tabs-below">
      ...
      <div id="bottom-dock-window-buttons">
        ...
        &nbsp;
        <button class="btn-bottomdock-glue btn btn-mini" type="button" title="<?php echo jLocale::get('view~map.bottomdock.toolbar.btn.glue.activate.title'); ?>"><?php echo jLocale::get('view~map.bottomdock.toolbar.btn.glue.activate.title'); ?></button>
