...
filemtime('C:\webserver\lizmap\prod\release_3_3\lizmap/modules/view/templates/map_switcher.tpl') > 1582985478){ return false;
} else {
...
?><div id="switcher-layers-container" class="switcher">
    <h3><span class="title"><span class="icon"></span>&nbsp;<span class="text"><?php echo jLocale::get('view~map.legendmenu.title'); ?></span></span></h3>
