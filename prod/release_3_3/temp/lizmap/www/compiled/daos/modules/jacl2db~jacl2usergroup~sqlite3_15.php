...
if (jApp::config()->compilation['checkCacheFiletime']&&(
 ...
 filemtime('C:\webserver\lizmap\prod\release_3_3\lib/jelix-modules/jacl2db/daos/jacl2usergroup.dao.xml') > 1582985478)){ return false;
}
else {
...
public function update ($record){
     throw new jException('jelix~dao.error.update.impossible',array('jacl2db~jacl2usergroup','C:\webserver\lizmap\prod\release_3_3\lib/jelix-modules/jacl2db/daos/jacl2usergroup.dao.xml'));
 }
